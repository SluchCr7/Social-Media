...
export default function MusicPage() {
  ...
  const { music: songs, isLoading, likeMusic, viewMusic ,currentMusic,setCurrentMusic } = useMusic()
  const {user} = useAuth()
  ...
  return (
    <div className="min-h-screen w-full relative">
      ...
      <SongPlayer playing={playing} togglePlay={togglePlay} progress={progress} duration={duration} current={current} setExpanded={setExpanded} />
      <ExpandedWindow current={current} expanded={expanded} setExpanded={setExpanded} progress={progress} duration={duration} formatTime={formatTime} playing={playing} togglePlay={togglePlay} />
