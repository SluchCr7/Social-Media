    ...
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-10 space-y-10 bg-lightMode-bg dark:bg-darkMode-bg text-lightMode-text dark:text-darkMode-text">
      ...
      <div className="relative bg-gradient-to-r from-sky-500 to-indigo-600 rounded-2xl text-white p-6 md:p-8 overflow-hidden shadow-lg">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="w-full md:w-1/3 flex justify-center md:justify-end">
            <div className="w-48 h-48 rounded-xl bg-lightMode-menu dark:bg-darkMode-menu p-4 flex items-center justify-center overflow-hidden">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {filtered.slice(0, visibleCount).length === 0 ? (
          <div className="col-span-full p-8 bg-lightMode-menu dark:bg-darkMode-menu rounded-2xl shadow flex flex-col items-center justify-center gap-4">
            <div className="w-32 h-32 bg-lightMode-bg dark:bg-darkMode-bg rounded-lg flex items-center justify-center">📭</div>
            <h3 className="text-lg font-semibold">No communities found</h3>
          ...
          filtered.slice(0, visibleCount).map((comm) => (
            <motion.article
              key={comm._id}
              whileHover={{ y: -6 }}
              className="bg-lightMode-menu dark:bg-darkMode-menu rounded-2xl shadow-md overflow-hidden border border-transparent hover:shadow-lg transition"
            >
              ...
              <div className="pt-10 pb-6 px-5 text-center">
                ...
                <div className="mt-4 flex items-center justify-center gap-3 flex-wrap">
                  <Link href={`/Pages/Community/${comm._id}`} className="px-4 py-2 rounded-lg border border-sky-600 text-sky-600">View</Link>
                </div>
              </div>
            </motion.article>
          ))
