...
const Search = () => {
  ...
  // Suggested Users (top 4 random users excluding current)
  ...
  return (
    <div className="w-full min-h-screen px-4 sm:px-8 py-8 text-lightMode-text dark:text-darkMode-text bg-lightMode-bg dark:bg-darkMode-bg transition">
      {/* Header */}
      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-3 gap-8">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="relative">
                      <Image
                        ...
                        width={60}
                        height={60}
                        className="rounded-full object-cover w-14 h-14 ring-2 ring-indigo-500"
                        loading="lazy"
                      />
        ...
        {/* Right Column: Trending / News / Suggested */}
        <div className="space-y-6">
          {/* Trending Hashtags */}
          <div className="bg-white/80 dark:bg-[#2b2d31]/90 p-4 rounded-xl shadow-sm backdrop-blur-md">
            ...
            <div className="flex flex-wrap gap-2">
              {trendingHashtags.map((tag) => (
                <span
                  key={tag}
                  className="px-3 py-1 bg-indigo-100 dark:bg-indigo-800/50 text-indigo-700 dark:text-indigo-200 rounded-full text-sm cursor-pointer hover:bg-indigo-200 dark:hover:bg-indigo-700 transition"
                >
                  {tag}
                </span>
              ))}
          ...
          <div className="bg-white/80 dark:bg-[#2b2d31]/90 p-4 rounded-xl shadow-sm backdrop-blur-md">
            ...
            <div className="space-y-3">
              {suggestedUsers.map((u) => (
                <div
                  key={u._id}
                  className="flex items-center justify-between bg-white/70 dark:bg-[#2b2d31]/80 rounded-xl p-2 hover:bg-white/90 dark:hover:bg-[#2b2d31]/70 transition"
                >
