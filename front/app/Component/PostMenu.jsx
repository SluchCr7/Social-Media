      ...
      <AnimatePresence>
        {showMenu && (
          <motion.div
            ...
            className="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg z-[1000] overflow-hidden"
            role="menu"
          >
            <motion.div
