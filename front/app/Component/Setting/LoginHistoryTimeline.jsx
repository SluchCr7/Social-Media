...
export default function LoginHistoryTimeline({ items = [] }) {
        ...
        {items.map((it, idx) => (
          ...
          >
            ...
            <div className="absolute -left-[9px] top-3">
              <div className="h-3.5 w-3.5 rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 shadow-lg shadow-blue-500/30 group-hover:scale-110 transition-transform duration-300" />
            </div>

            {/* بطاقة الحدث */}
            <div className="p-4 rounded-xl bg-white/60 dark:bg-gray-800/60 backdrop-blur-md border border-gray-200/40 dark:border-gray-700/40 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex items-center gap-1 text-xs text-gray-500 dark:text-gray-400 mt-1 sm:mt-0">
                  ...
                  {it.date ? dayjs(it.date).fromNow() : t('Unknown time')}
                </div>
              </div>
