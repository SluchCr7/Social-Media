  ...
  return (
    <div className="flex flex-col items-center justify-center p-12 text-center pointer-events-none select-none">
      ...
      >
        ...
        <div className="relative z-10 w-24 h-24 border border-gray-200 dark:border-white/10 rounded-[2rem] flex items-center justify-center bg-gray-50 dark:bg-white/[0.01]">
          <div className="w-8 h-8 rounded-full bg-gray-200 dark:bg-white/10 animate-pulse" />
        </div>
      </motion.div>

      <h2 className="text-2xl font-black text-gray-900 dark:text-white/60 mb-2 tracking-tight">Decentralized Hub</h2>
      <p className="text-sm text-gray-500 dark:text-white/30 max-w-xs leading-relaxed">
