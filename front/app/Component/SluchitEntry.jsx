  ...
  return (
    <div className="relative w-full">
      ...
      <motion.div
        ...
        "
      >
        {/* ======= Overlay Blur for Sensitive Content (تصميم احترافي ومحسن) ======= */}
        <AnimatePresence>
          {showSensitive && (
            <motion.div
              initial={{ opacity: 0 }}
              ...
              "
            >
              {/* خلفية ضبابية متدرجة لتعطي عمق ونعومة */}
              <div
                className="
                  absolute inset-0
                  bg-gradient-to-b from-gray-900/60 via-gray-900/50 to-black/60
              ...
              {/* صندوق التحذير بتوسيط وتباعد مريح */}
              <motion.div
