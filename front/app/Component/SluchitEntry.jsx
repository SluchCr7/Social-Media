...
//               </div>
//               <p className='text-sm text-gray-300 w-[70%]'>{original?.text}</p>
//               {original?.Photos && (
    ...
    <div className="bg-white/10 dark:bg-black/20 backdrop-blur-xl border border-gray-200 dark:border-gray-700 w-full p-6 rounded-2xl flex flex-col gap-5 shadow-2xl transition-all duration-300 hover:scale-[1.01]">
      ...
      <div className='flex items-start gap-4'>
        ...
        <div className='flex flex-col w-full gap-3'>
          ...
          {/* Shared Post Text */}
          {isShared && post?.text && (
            <p className='text-sm text-gray-600 dark:text-gray-200 w-[50%] break-all whitespace-pre-wrap'>
              {post?.text}
            </p>
          )}
          ...
          {isShared && original && (
            <div className='bg-white/40 dark:bg-white/5 backdrop-blur-md 
              ...
              <p className='text-sm text-gray-700 dark:text-gray-300 w-[50%] italic break-all whitespace-pre-wrap'>
                {original?.text}
              </p>
