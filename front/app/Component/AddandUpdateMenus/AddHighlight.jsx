      ...
      {openModal && (
        ...
        >
          <motion.div
            ...
            className="relative w-[95%] max-w-5xl max-h-[90vh] rounded-3xl bg-white/75 dark:bg-gray-900/85 
                       backdrop-blur-xl border border-white/10 dark:border-gray-700 shadow-2xl overflow-hidden flex flex-col"
            onMouseDown={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div className="flex items-center justify-between gap-3 px-5 py-3 border-b border-white/10 shrink-0 bg-white/40 dark:bg-gray-900/40">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center bg-gradient-to-tr from-indigo-50 to-purple-50 dark:from-gray-800 dark:to-gray-800/60">
                  <FaImage className="text-indigo-600" />
                </div>
                <div>
                  <h3 className="text-lg font-semibold bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-purple-500">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-1 flex flex-col gap-4">
                  ...
                  >
                    {preview ? (
                      <>
                        <Image src={preview} alt="cover preview" fill className="object-cover" />
                        <div className="absolute inset-0 flex items-end justify-between p-3 text-white text-xs bg-gradient-to-t from-black/30 to-transparent">
                          <div className="bg-black/40 px-2 py-1 rounded-md">Preview</div>
                          <div className="bg-black/40 px-2 py-1 rounded-md">Tap to change</div>
                        </div>
                      </>
                    ) : (
                      <div className="flex flex-col items-center gap-2 text-gray-500 dark:text-gray-400 pointer-events-none">
                        <FaImage size={28} />
                        <div className="text-sm">Upload cover image</div>
                        <div className="text-xs">PNG, JPG — 1080×1920 recommended</div>
                      </div>
                    )}
                    <input
                      ref={fileInputRef}
                ...
                <div className="md:col-span-2 flex flex-col gap-3">
                  <div className="flex items-center justify-between flex-wrap gap-2">
                    <div>
                      <h4 className="text-sm font-medium text-gray-700 dark:text-gray-200">Select Stories</h4>
                      <p className="text-xs text-gray-500 dark:text-gray-400">Click to include stories</p>
                    </div>
